...
def class_vacancy1():
    return Vacancy("1", "vacancy1_name", "https://api.hh.ru/vacancy1",
                   "2024-03-12T16:41:33+0301", 10000)


@pytest.fixture
def class_vacancy2():
    return Vacancy("2", "vacancy2_name", "https://api.hh.ru/vacancy2",
                   "2024-03-12T16:41:33+0302", 20000)
...
def test__str__(class_vacancy1):
    assert str(class_vacancy1) == ('id выкансии - 1\nМин.зарплата - 10000\nСсылка - '
                                   'https://api.hh.ru/vacancy1\nОпубликована - 2024-03-12T16:41:33+0301\n')


def test__lt__(class_vacancy1, class_vacancy2):
